...
import { VERSION } from '@angular-devkit/build-angular/src/utils/package-version';
import {
  ApplicationPresetOptions,
  I18nPluginCreators,
  requiresLinking,
} from '@angular-devkit/build-angular/src/tools/babel/presets/application';
...
export default custom<ApplicationPresetOptions>(() => {
  console.log(">>>DBG>>>", "Start BABEL Loader")
    ...
    config(configuration, { customOptions }) {
      return {
        ...
        presets: [
          ...
          [
            require('@angular-devkit/build-angular/src/tools/babel/presets/application').default,
            {
              ...customOptions,
              diagnosticReporter: (type, message) => {
                console.log(">>DBG >>>", "CUSTOM DIAGNOSTIC REPORTER")
                switch (type) {
                  case 'error':
